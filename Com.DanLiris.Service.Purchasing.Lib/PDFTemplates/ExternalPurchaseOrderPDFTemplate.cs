...
namespace Com.DanLiris.Service.Purchasing.Lib.PDFTemplates
{
    public class ExternalPurchaseOrderPDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(ExternalPurchaseOrderViewModel viewModel, int clientTimeZoneOffset)
        {
            ...
            cellHeaderContentLeft.Phrase = new Phrase("PT. MULTIYASA ABADI SENTOSA", bold_font4);
            ...
            string firstParagraphString = "Yang bertanda tangan di bawah ini, PT. MULTIYASA ABADI SENTOSA, SOLO (selanjutnya disebut sebagai pihak Pembeli) dan " + viewModel.supplier.name + "(selanjutnya disebut sebagai pihak Penjual) saling menyetujui untuk mengadaan kontrak jual beli dengan ketentuan sebagai berikut : ";
